...
> [!TIP]
> 👉 **Check out [our cfoldseeker Zenodo community](https://zenodo.org/communities/cfoldseeker/records) with premade input files generated by our userbase!** 👈
> 
> Generating the input files for local cfoldseeker searches (Foldseek protein databases, sequence preclustering tables) is computationally expensive. **Save yourself this effort and help other doing so by submitting your setup!**
